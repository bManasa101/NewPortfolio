...
export default function Dashboard() {
    ...
    <div style={{ minHeight: "100vh", background: "#080a0f", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Segoe UI',system-ui,sans-serif" }}>
      <div style={{ background: "#0e1117", border: "1px solid #3a4258", borderRadius: 8, padding: "2.5rem", width: "100%", maxWidth: 380 }}>
        ...
        <input
          ...
          style={{ width: "100%", background: "#13181f", border: `1px solid ${pwErr ? "#e74c3c" : "#3a4258"}`, color: "#f0f2f5", padding: "0.8rem 1rem", borderRadius: 4, fontFamily: "inherit", fontSize: "0.9rem", outline: "none", marginBottom: "0.6rem", boxSizing: "border-box" }}
        />
  ...
  if (view === "add" || view === "edit") return (
    <ReportForm
      initial={editing}
      onSave={(r) => {
        editing ? updateReport(editing.slug, r) : addReport(r);
        setView("list");
        setEditing(null);
      }}
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080a0f", fontFamily: "'Segoe UI',system-ui,sans-serif", color: "#f0f2f5" }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "60px 2rem", position: "relative", zIndex: 1 }}>
        ...
        {/* Table */}
        {!ready ? (
          <div style={{ color: "#7a8499" }}>Loading…</div>
        ) : reports.length === 0 ? (
                    ...
                    <td style={{ padding: "1rem 1.2rem" }}>
                      {r.rec ? (
                        <span style={{
                          ...
                          ...(r.rec === "Buy"  ? { background: "rgba(46,204,113,0.1)", color: "#2ecc71", border: "1px solid rgba(46,204,113,0.2)" }
                            : r.rec === "Hold" ? { background: "rgba(200,169,110,0.1)", color: "#c8a96e", border: "1px solid rgba(200,169,110,0.2)" }
